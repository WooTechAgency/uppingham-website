...
export function Campus() {
  ...
  return (
    <section className="relative py-25  before:content-[''] before:absolute before:top-0 before:left-[50%] before:w-[1px] before:h-full before:bg-red before:z-[21] before:translate-x-[-50%]">
